...
import { Lazy, MarkResizable, SetOptional, Force, Create as Create_1, GetOptional, CreateFuncWithArgs, DeleteEmptyFields, OnLoad } from "./WebSharper.Core.JavaScript/Runtime.js"
function isIDisposable(x){
  return"Dispose"in x;
}
function Main(){
  const M=_c_11.EmbedView(Map((endpoint) => endpoint.$==1?FormPage():HomePage(), currentPage().View));
...
function FormPage(){
  return Render((_1) =>(_2) =>() =>(_3) =>(_4) =>(_5) => {
    const this_1=new _c_1("New_1");
    const this_2=(this_1.h.push(new _c_7("title", "Thank you for leaving a feedback")),this_1);
    const this_3=(this_2.h.push(new _c_14("name", _1)),this_2);
    const this_4=(this_3.h.push(new _c_14("ux", _2)),this_3);
    const this_5=(this_4.h.push(new _c_14("message", _3)),this_4);
    const t=(this_5.h.push(new _c_13("privacypolicy", _4)),this_5);
    const b=(t.h.push(EventQ2(t.k, "onsubmit", () => t.i, () => {
      _5.Trigger();
    })),t);
    const p=CompleteHoles(b.k, b.h, [["name", 0, null], ["ux", 0, null], ["message", 0, null], ["privacypolicy", 2, null]]);
    const i=new _c_5(p[1], form1(p[0]));
    let _6=(b.i=i,i);
    return _6.Doc;
  }, Run((data) => {
    alert("You submitted: "+String(data));
  }, WithSubmit(op_LessMultiplyGreater(op_LessMultiplyGreater(op_LessMultiplyGreater(op_LessMultiplyGreater(op_LessMultiplyGreater(Return((name) =>(ux) =>(options) =>(message) =>(pp) =>[name, ux, options, message, pp]), IsNotEmpty("Can't be empty", Yield(""))), Yield("")), Yield("")), Yield("")), Yield(false)))));
}
function HomePage(){
  const input=_c_10.Create_1("0");
  const viewInput=input.View;
  const c=Map((value) => value!="0"?String(Number(value)*0.3048):"Error", viewInput);
  const c_1=Map((value) => value!="0"?String(Number(value)*30.48):"Error", viewInput);
  const this_1=new _c_1("New_1");
  const this_2=(this_1.h.push(new _c_7("tohomepage", "/#/form")),this_1);
  const this_3=(this_2.h.push(new _c_14("input", input)),this_2);
  const this_4=(this_3.h.push(new _c_17("convertfromresult", viewInput)),this_3);
  const this_5=(this_4.h.push(new _c_17("converttoresult1", c_1)),this_4);
  const b=(this_5.h.push(new _c_17("converttoresult2", c)),this_5);
  const p=CompleteHoles(b.k, b.h, [["input", 0, null]]);
  const i=new _c_5(p[1], conversionpage(p[0]));
  let _1=(b.i=i,i);
  return _1.Doc;
}
...
function Yield(init_2){
  return YieldVar(_c_10.Create_1(init_2));
}
function WithSubmit(p){
  const submitter=new _c_9(p.view, Failure(_c_12.Empty));
...
function Render(renderFunction, p){
  ...
  return _c_11.Append(_c_11.EmbedView(Map(() => _c_11.Empty, p.view)), x);
}
...
function YieldVar(var_1){
  return New_1(var_1.Id, Map(Success, var_1.View), (r) => r(var_1));
}
function Map_1(f, p){
  return MapResult((a) => Map_3(f, a), p);
}
function MapResult(f, p){
  return New_1(p.id, Map(f, p.view), p.render);
}
function IsNotEmpty(msg, p){
  return Is((x) => x!="", msg, p);
}
function Is(pred, msg, p){
  return MapResult((res) => res.$==1?res:pred(res.$0)?res:Failure(ofArray([new _c_28(p.id, msg)])), p);
}
...
function EventQ2(_1, holeName, ti, f){
  return new _c_15(holeName, (el) =>(ev) => {
    const i=ti();
    i.SetAnchorRoot(el);
    return f({
      Vars:i, 
  ...
  return[append(filledHoles, choose((_1) => {
    ...
    if(filledVars.Contains(name))return null;
      ...
      const r=ty===0?_c_20.GetOrAddHoleFor(key, name, () => {
        ...
        let _2=_c_10.Create_1(o==null?"":o.$0);
        return new _c_14(name, _2);
      }):ty===1?_c_20.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_10.Create_1(o==null?0:o.$0);
        return new _c_21(name, _2);
      }):ty===2?_c_20.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_10.Create_1(o==null?false:o.$0);
        return new _c_13(name, _2);
      }):ty===3?_c_20.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_10.Create_1(o==null?-8640000000000000:o.$0);
        return new _c_22(name, _2);
      }):ty===4?_c_20.GetOrAddHoleFor(key, name, () => new _c_23(name, _c_10.Create_1([]))):ty===5?_c_20.GetOrAddHoleFor(key, name, () => new _c_24(name, _c_10.Create_1(Some(globalThis.document.querySelector("[ws-dom="+name+"]"))))):ty===6?_c_20.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_10.Create_1(o==null?[]:o.$0);
...
let _c_9=Lazy((_i) => class Submitter extends _c {
  static {
    _c_9=_i(this);
  }
  input;
...
function form1(h){
  ...
  return h?NamedTemplate("index", Some("form1"), h):void 0;
}
function conversionpage(h){
  LoadLocalTemplates("index");
  return h?NamedTemplate("index", Some("conversionpage"), h):void 0;
}
function Router_EndPoint(){
  return JSUnion(void 0, [[null, [[null, []]], []], [null, [[null, ["form"]]], []]]);
}
let _c_10=Lazy((_i) => class Var extends _c {
  static {
    _c_10=_i(this);
  }
  static Create_1(v){
...
let _c_11=Lazy((_i) => class Doc extends _c {
  ...
  static EmbedView(view){
    ...
    return _c_11.Mk(EmbedDoc(node), Map(() => { }, Bind((doc) => {
      UpdateEmbedNode(node, doc.docNode);
      return doc.updates;
    }, view)));
  }
  static Append(a, b){
    return _c_11.Mk(AppendDoc(a.docNode, b.docNode), Map2Unit(a.updates, b.updates));
  }
  static get Empty(){
  ...
  static TextView(txt){
    ...
    return _c_11.Mk(TextDoc(node), Map((t) => {
...
function InstallHash(onParseError, router_1){
  const var_1=_c_10.Create_1(void 0);
...
function Map2Opt1(fn, x, sn2){
  return Map_2((y) => fn(x, y), sn2);
}
function Map2Opt2(fn, y, sn1){
  return Map_2((x) => fn(x, y), sn1);
}
...
let _c_12=Lazy((_i) => class FSharpList {
  static {
    _c_12=_i(this);
  }
  static Empty=Create_1(_c_12, {$:0});
...
function ofSeq(xs){
  ...
  else if(xs instanceof _c_12)return ofList(xs);
  else {
    const q=[];
    const o=Get(xs);
    try {
...
function RenderedFullDocTemplate(){
  return _c_32.RenderedFullDocTemplate;
}
...
function ChildrenTemplate(el, fillWith){
  ...
  return!Equals(m, null)&&m.length===1&&(get(m, 0)instanceof Node&&(Equals(get(m, 0).nodeType, Node.ELEMENT_NODE)&&(_1=get(m, 0),true)))?_c_33.TreeNode(docTreeNode, updates):_c_11.Mk(TreeDoc(docTreeNode), updates);
}
function set_RenderedFullDocTemplate(_1){
  _c_32.RenderedFullDocTemplate=_1;
}
function LocalTemplatesLoaded(){
  return _c_32.LocalTemplatesLoaded;
}
function set_LocalTemplatesLoaded(_1){
  _c_32.LocalTemplatesLoaded=_1;
}
...
function InlineTemplate(el, fillWith){
  ...
  foreachNotPreserved(el, "[ws-on]", (e_1) => {
    addAttr(e_1, _c_38.Concat(choose((x_1) => {
      ...
      if(m[0]){
        const th=m[1];
        return th instanceof _c_37?Some(Handler(get(a, 0), th.Value)):th instanceof _c_15?Some(_c_38.Handler(get(a, 0), th.Value)):(console.warn("Event hole on"+get(a, 0)+" filled with non-event data", get(a, 1)),null);
      }
      else return null;
    ...
    for(let i=0, _5=holeAttrs.length-1;i<=_5;i++)((() => {
      ...
      const value=foldBack((_7, _8) =>(((t) => {
        ...
        return(t_1) => {
          ...
          return holeContent.$==1?[textBefore_1, _c_12.Cons(textAfter==""?holeContent.$0:Map((s_5) => s_5+textAfter, holeContent.$0), views)]:[textBefore_1+holeContent.$0+textAfter, views];
        };
      })(_7))(_8), res, [finalText, _c_12.Empty]);
      if(value[1].$==1){
        if(value[1].$1.$==1){
          if(value[1].$1.$1.$==1){
            if(value[1].$1.$1.$1.$==0){
              ...
              const s_2=value[0];
              _6=Dynamic_1(attrName, Map((vs) => s_2+concat_2("", vs), Sequence(value[1])));
            }
          }
          else {
            const s_3=value[0];
      ...
      else _6=_c_38.Create(attrName, value[0]);
...
let _c_27=Lazy((_i) => class Route {
  ...
  static Combine(paths){
    ...
    if(m===0)return _c_27.Empty;
      ...
      body=null;
      const segments=[];
      queryArgs=new _c_34("New", []);
      formData=new _c_34("New", []);
      iter_1((p) => {
        const m_1=p.Method;
      ...
      return _c_27.New(ofSeq_1(segments), queryArgs, formData, method, body);
    }
  }
  static Segment(s, m){
  ...
  static get Empty(){
    return _c_27.New(_c_12.Empty, new _c_34("New", []), new _c_34("New", []), null, Some(null));
  }
  static FromUrl(path, strict){
    const m=path.indexOf("?");
    const p=m===-1?[path, new _c_34("New", [])]:[Substring(path, 0, m), _c_27.ParseQuery(path.substring(m+1))];
  ...
  static ParseQuery(q){
    return OfArray(ofSeq(choose((kv) => {
...
function JSUnion(t, cases){
  ...
  return New((path) => collect((_1) => {
        ...
        if(m_1.$==0)return[[_c_27.New(p, path.QueryArgs, path.FormData, path.Method, path.Body), createCase(i, [])]];
          ...
          function collect_1(fields){
            return(path_1) =>(acc) => {
              if(fields.$==1){
                const t_1=fields.$1;
                return collect((_2) =>((collect_1(t_1))(_2[0]))(_c_12.Cons(_2[1], acc)), fields.$0.Parse(path_1));
              }
              else return[[path_1, createCase(i, ofList(rev_1(acc)))]];
            };
          }
          return((collect_1(m_1))(_c_27.New(p, path.QueryArgs, path.FormData, path.Method, path.Body)))(_c_12.Empty);
        }
      }
    }
    else return[];
    ...
    if(fields.length==0)return Some(casePath);
      ...
      return forall_1((o) => o!=null, fieldParts)?Some(append(casePath, collect((o) => o.$0, fieldParts))):null;
    }
  });
}
...
function ofArray(arr){
  let r=_c_12.Empty;
  for(let i=length(arr)-1, _1=0;i>=_1;i--)r=_c_12.Cons(get(arr, i), r);
  return r;
}
function rev_1(l){
  let res=_c_12.Empty;
...
function ofSeq_1(s){
  if(s instanceof _c_12)return s;
    ...
    try {
      let r;
      let go=e.MoveNext();
      if(!go)return _c_12.Empty;
      else {
        const res=Create_1(_c_12, {$:1});
        r=res;
        while(go)
          {
            r.$0=e.Current;
            if(e.MoveNext()){
              const t=Create_1(_c_12, {$:1});
              r=(r.$1=t,t);
            }
            else go=false;
          }
...
let _c_28=Lazy((_i) => class ErrorMessage extends _c {
  static {
    _c_28=_i(this);
  }
  id;
...
function Concat(xs){
  ...
  return Join_2("", ofSeq(sb));
}
function WriteQuery(q){
  return concat_2("&", map((_1) => _1[0]+"="+_1[1], ToSeq(q)));
}
...
let _c_30=Lazy((_i) => class $StartupCode_Forms {
  static {
    _c_30=_i(this);
  }
  static Int;
...
let _c_32=Lazy((_i) => class $StartupCode_Templates {
  static {
    _c_32=_i(this);
  }
...
function wrapMap(){
  return _c_46.wrapMap;
}
function defaultWrap(){
  return _c_46.defaultWrap;
}
function rxhtmlTag(){
  return _c_46.rxhtmlTag;
}
function rtagName(){
  return _c_46.rtagName;
}
...
function OfArray(a){
  return new _c_34("New_1", OfSeq(map((_1) => _c_44.New(_1[0], _1[1]), a)));
}
let _c_34=Lazy((_i) => class FSharpMap extends _c {
  static {
    _c_34=_i(this);
  }
  tree;
  Add_1(k, v){
    return new _c_34("New_1", Add(_c_44.New(k, v), this.tree));
  }
  get IsEmpty(){
...
function cancel(c){
  c.k(Cc(new _c_56("New", c.ct)));
}
let _c_35=Lazy((_i) => class $StartupCode_Abbrev {
  static {
    _c_35=_i(this);
  }
  static counter;
...
function Static(attr){
  return _c_38.A3(attr);
}
function Dynamic(view, set_1){
  return _c_38.A1(new _c_50(view, set_1));
}
function EmptyAttr(){
...
function ValueWith(bind, var_1){
  const p=bind(var_1);
  return _c_38.Append(Static(p[0]), DynamicCustom(p[1], p[2]));
}
function DynamicCustom(set_1, view){
  return Dynamic(view, set_1);
}
let _c_38=Lazy((_i) => class Attr {
  static {
    _c_38=_i(this);
  }
  static Handler(event, q){
    return _c_38.HandlerImpl(event, q);
  }
  static Concat(xs){
    const x=ofSeqNonCopying(xs);
    return TreeReduce(EmptyAttr(), _c_38.Append, x);
  }
    ...
    while(true)
      {
        if(t_1==null)return spine.$==1?Some([spine.$0[0], [spine.$0[1], spine.$1]]):null;
          ...
          t_2=t_1;
          t_1=t_2.Right;
          spine=_c_12.Cons([t_2.Node, t_2.Left], spine);
        }
        else {
          t_2=t_1;
          t_1=t_2.Left;
          spine=_c_12.Cons([t_2.Node, t_2.Right], spine);
        }
      }
  }
  return unfold((_1) => gen(_1[0], _1[1]), [t, _c_12.Empty]);
}
function Add(x, t){
...
let _c_44=Lazy((_i) => class Pair {
  ...
  static New(Key, Value_1){
    return Create_1(_c_44, {Key:Key, Value:Value_1});
  }
});
...
let _c_45=Lazy((_i) => class KeyCollection extends _c {
  static {
    _c_45=_i(this);
  }
  d;
...
let _c_46=Lazy((_i) => class $StartupCode_DomUtility {
  static {
    _c_46=_i(this);
  }
  static defaultWrap;
...
let _c_47=Lazy((_i) => class $StartupCode_Animation {
  static {
    _c_47=_i(this);
  }
...
function fromSeq(s){
  const a=ofSeq(map((_1) => _c_44.New(_1[0], _1[1]), distinctBy((t) => t[0], rev(s))));
  sortInPlace(a);
  return Build(a, 0, a.length-1);
}
let _c_48=Lazy((_i) => class Scheduler extends _c {
  static {
    _c_48=_i(this);
  }
  idle;
...
let _c_50=Lazy((_i) => class DynamicAttrNode extends _c {
  static {
    _c_50=_i(this);
  }
  push;
...
let _c_51=Lazy((_i) => class Client {
  ...
  static {
    ...
    this.IntGetChecked=(el) => {
      ...
      let o;
      const s_8=el.value;
      if(isBlank(s_8))_1=(el.checkValidity?el.checkValidity():true)?_c_54.Blank(s_8):_c_54.Invalid(s_8);
      else {
        const m=(o=0,[TryParse(s_8, {get:() => o, set:(v) => {
          o=v;
        }}), o]);
        _1=m[0]?_c_54.Valid(m[1], s_8):_c_54.Invalid(s_8);
      }
      return Some(_1);
    };
    ...
    this.FloatGetChecked=(el) => {
      ...
      if(isBlank(s_8))_1=(el.checkValidity?el.checkValidity():true)?_c_54.Blank(s_8):_c_54.Invalid(s_8);
        ...
        const i=+s_8;
        _1=isNaN(i)?_c_54.Invalid(s_8):_c_54.Valid(i, s_8);
      }
      return Some(_1);
    };
...
let _c_53=Lazy((_i) => class $StartupCode_Concurrency {
  static {
    _c_53=_i(this);
  }
  static GetCT;
  ...
  static {
    ...
    this.scheduler=new _c_48();
    this.defCTS=[new _c_55()];
    this.Zero=Return_1();
    this.GetCT=(c) => {
      c.k(Ok(c.ct));
    };
...
let _c_54=Lazy((_i) => class CheckedInput {
  static {
    _c_54=_i(this);
  }
  get Input(){
...
let _c_55=Lazy((_i) => class CancellationTokenSource extends _c {
  static {
    _c_55=_i(this);
  }
  init;
